// taken from CIS 4600 Scene Graph source code
...
void ShaderProgram::create(const char *vertfile, const char *fragfile)
{
    ...
    const char* ptrvertSource = vertSource;
    const char* ptrfragSource = fragSource;


    // Send the shader text to OpenGL and store it in the shaders specified by the handles vertShader and fragShader
    context->glShaderSource(m_vertShader, 1, &ptrvertSource, 0);
    context->glShaderSource(m_fragShader, 1, &ptrfragSource, 0);
